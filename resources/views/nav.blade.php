        ...
        <ul class="metismenu" id="menu">
            ...
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="{{ route('branch.register') }}">Branch Register</a></li>
                    <li><a href="{{ route('entity.register') }}">Facility Register</a></li>
                    <li><a href="{{ route('item.register') }}">Item Register</a></li>
                    <li><a href="{{ route('purchase.register') }}">Purchase Register</a></li>
                    <li>
