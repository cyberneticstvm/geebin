                        ...
                        <div class="basic-form">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-2">
                                    ...
                                    {{ html()->select($name = 'supplier_id', $companies->where('type_id', 1)->pluck('name', 'id'), old('supplier_id'))->class('form-control')->placeholder('Select') }}
                                    @error('supplier_id')
                                ...
                                <div class="mb-3 col-md-2">
                                    ...
                                    {{ html()->select($name = 'company_id', $companies->where('type_id', 2)->pluck('name', 'id'), old('company_id'))->class('form-control')->placeholder('Select') }}
                                    @error('company_id')
