    ...
    <div class="container-fluid">
        <div class="page-titles">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('production.register', ['type' => encrypt($type->id), 'stype' => $stype]) }}">Production</a></li>
                ...
                <div class="card dz-card">
                    <div class="card-body">
                        <div class="basic-form">
                            {{ html()->form('POST', route('production.save', ['type' => encrypt($type->id), 'stype' => $stype]))->attribute('id', 'frmProduction')->open() }}
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    {{ html()->select($name = 'from_entity', $value = $entities->where('type_id', 2)->pluck('name', 'id'), old('from_entity') ?? 1)->class('form-control single-select')->placeholder('Select') }}
                                    @error('from_entity')
                                ...
                                <div class="col-md-2">
                                    ...
                                    {{ html()->select($name = 'to_entity', $value = $entities->where('type_id', 3)->pluck('name', 'id'), old('to_entity') ?? 1)->class('form-control single-select')->placeholder('Select') }}
                                    @error('to_entity')
