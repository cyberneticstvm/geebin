            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center bg-transparent border-bottom-0 mt-3">
                        <div class="col-6">
                            <h5 class="m-0">Create Production</h5>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="basic-form">
                            {{ html()->form('POST', route('production.save'))->attribute('id', 'frmProduction')->open() }}
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col text-end">
                                    ...
                                    {{ html()->submit("Save Production")->attribute('onClick', "return checkInventory('frmProduction', 'material')")->class("btn btn-submit btn-primary") }}
                                </div>
                            </div>
                            {{ html()->form()->close() }}
                        </div>
