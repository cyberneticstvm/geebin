                ...
                <div class="card dz-card">
                    <div class="card-body">
                        <div class="basic-form">
                            ...
                            @forelse($production->details->where('item_id', 1)->where('type', 'out') as $key => $pro)
                            <div class="row">
                                <div class="col-md-2">
                                    <label class="form-label req">Item</label>
                                    {{ html()->select($name = 'item_ids[]', $items->where('type', 12)->pluck('name', 'id'), $pro->item_id)->class('form-control single-select')->attribute('id', $pro->id)->placeholder('Select') }}
                                    @error('item_ids')
                                ...
                                <div class="mb-3 col-md-2">
                                    ...
                                    {{ html()->text('qty[]', $pro->qty)->class("form-control")->placeholder("0") }}
                                    @error('qty')
