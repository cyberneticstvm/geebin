            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center bg-transparent border-bottom-0 mt-3">
                        <div class="col-6">
                            <h5 class="m-0">Update Material</h5>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="basic-form">
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-3">
                                    ...
                                    {{ html()->text('name', $material->name)->class("form-control")->placeholder("Material Name") }}
                                    @error('name')
                                ...
                                <div class="mb-3 col-md-2">
                                    ...
                                    {{ html()->select($name = 'type', materialTypes(), $material->type)->class('form-control')->placeholder('Select') }}
                                    @error('type')
                                ...
                                <div class="mb-3 col-md-2">
                                    ...
                                    {{ html()->select($name = 'unit', $value = array('Kilo' => 'Kilo', 'Number' => 'Number', 'Litre' => 'Litre'), $material->unit)->class('form-control')->placeholder('Select') }}
                                    @error('unit')
                                ...
                                <div class="mb-3 col-md-2">
                                    ...
                                    {{ html()->number('cost_per_unit', $material->cost_per_unit)->class("form-control")->placeholder("0.0") }}
                                    @error('cost_per_unit')
                            ...
                            <div class="row">
                                <div class="col text-end">
                                    ...
                                    {{ html()->submit("Update Material")->class("btn btn-submit btn-primary") }}
                                </div>
                            </div>
                            {{ html()->form()->close() }}
                        </div>
