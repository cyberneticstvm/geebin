...
<div class="content-body crm-main style-1">
    <div class="container">
        <div class="row">
            <div class="col text-end text-info">Welcome {{ Auth::user()->name }}, You are currently logged in <span class="text-primary">{{ Session::get('branch')?->name ?? '' }}</span> Branch!</div>
        </div>
    </div>
</div>
<!--**********************************
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        {{ html()->select($name = 'branch', $branches->pluck('name', 'id'), NULL)->class('form-control')->placeholder('Select Branch')->required() }}
                        @error('branch')
