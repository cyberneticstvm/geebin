                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-6 d-flex justify-content-center align-items-center border-0 rounded-lg auth-h100">
                            <div class="w-100 p-4 p-md-5 card border-0" style="max-width: 32rem;">
                                <!-- Form -->
                                <form class="row g-1 p-0 p-md-4" method="post" action="{{ route('login.auth') }}">
                                    @csrf
                                    ...
                                    <div class="col-12">
                                        <div class="mb-2">
                                            ...
                                            <input type="email" name="email" value="{{ $email ?? old('email') }}" class="form-control" placeholder="hello@example.com">
                                        </div>
                                        @error('email')
                                        ...
                                        <div class="mb-2">
                                            <div class="form-label">
                                                <span class="d-flex justify-content-between align-items-center">
                                                    Password
                                                    <a class="text-primary" href="{{ route('login') }}">Forgot Password?</a>
                                                </span>
                                            </div>
                                    ...
                                    <div class="col-12 text-center mt-4">
                                        <button type="submit" class="btn btn-submit btn-block btn-dark lift text-uppercase">SIGN IN</button>
                                    </div>
                                    <div class="col-12 text-center mt-4">
                                        <span class="text-muted">Don't have an account yet? <a href="{{ route('login') }}">Sign up here</a></span>
                                    </div>
                                </form>
                                <!-- End Form -->
                            </div>
